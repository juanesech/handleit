                    ...
                    <details>
                        <summary class="bg-gray-100 group cursor-pointer hover:bg-blue-600 hover:ring-blue-600 list-none flex flex-wrap items-center rounded-sm">
                            <div class="rounded-sm px-4 py-3 sm:px-6 group-hover:bg-blue-600 hover:ring-blue-600">
                                <h4 class="group-hover:text-white text-md text-gray-600">{source.name}</h4>
                        ...
                        <dl>
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-xs text-gray-900 sm:col-span-2 sm:mt-0">{source.type}</dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-xs font-medium text-gray-500">Address</dt>
                                <dd class="mt-1 text-xs text-gray-900 sm:col-span-2 sm:mt-0">{source.address}</dd>
                            </div>
                            {source.type === "GitLab" ?
                                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    <dt class="text-xs font-medium text-gray-500">Group</dt>
                                    <dd class="mt-1 text-xs text-gray-900 sm:col-span-2 sm:mt-0">{source.group}</dd>
                                </div> : <></>}
                        </dl>
                    </details>
